...
class StickerPackViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    @objc func topViewTapped(){
        ...
        if let url = URL(string: "itms-apps://apple.com/app/id1526954927") {
    ...
    override func viewDidLoad() {
        ...
        addButton.backgroundColor = #colorLiteral(red: 0.4196078431, green: 0.6039215686, blue: 0.03921568627, alpha: 1)
        ...
        tapGuideLabel.text = "Tap on any sticker to copy or share it over other apps"
    ...
    @objc func infoPressed(button: UIButton) {
        ...
        let vc = storybaord.instantiateViewController(identifier: "PrivacyVC") as! PrivacyVC
